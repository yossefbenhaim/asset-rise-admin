    ...
    <ChartCard title={title} sub={sub} index={index}>
      <ResponsiveContainer width="100%" height={height}>
        <BarChart
          ...
          margin={{ top: 8, right: horizontal ? 36 : 8, left: horizontal ? 8 : -8, bottom: 0 }}
        ...
        >
          ...
          <Tooltip
            ...
            cursor={{ fill: color, fillOpacity: 0.07, radius: 6 }}
          />
          <Bar
            dataKey={yKey}
            fill={`url(#${gid})`}
          ...
          >
            {horizontal && (
              <LabelList
                ...
                formatter={
                  ((v: any) =>
                    valueFmt ? valueFmt(Number(v)) : Number(v).toLocaleString('he-IL')) as any
                }
              />
            )}
          </Bar>
