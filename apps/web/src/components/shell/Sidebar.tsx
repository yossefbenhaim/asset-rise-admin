...
import { Home, Mail, Inbox, Users, Building2, ScrollText, Search, Briefcase, Handshake, Gavel, Vote, ListChecks, FileText, MessagesSquare, Megaphone, ClipboardCheck, Circle, FileBarChart2, Activity, CreditCard, Radar, Sparkles, FileWarning, FileCheck2, AlertTriangle, MessageCircle } from 'lucide-react'
...
const ICONS: Record<string, any> = { Home, Mail, Inbox, Users, Building2, ScrollText, Search, Briefcase, Handshake, Gavel, Vote, ListChecks, FileText, MessagesSquare, Megaphone, ClipboardCheck, FileBarChart2, Activity, CreditCard, Radar, Sparkles, FileWarning, FileCheck2, AlertTriangle, MessageCircle }
